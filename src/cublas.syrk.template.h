cublasStatus_t CULIP_FUNC_NAME(cublasHandle_t handle, cublasFillMode_t uplo,
                               ...
                               int lda, const CULIP_TYPE *beta, CULIP_TYPE *C,
                               int ldc) {
#ifdef __CUDA_ARCH__
  ...
  cublasStatus_t (*cublas_lib_func)(cublasHandle_t, cublasFillMode_t,
  ...
  *(void **)(&cublas_lib_func) = CULiP_get_function_pointer(
  ...
  // Call the function
  const cublasStatus_t result = (*cublas_lib_func)(handle, uplo, trans, n, k,
